...
export const Icon_2 = props => {
  return (
    ...
    >
      <defs>
        <clipPath id="_clipPath_faiTCqnlDOMSx7r33ARLuzmmXa8KLn95">
          <rect className={props.className} width="100" height="150" />
        </clipPath>
      </defs>
      <g clip-path="url(#_clipPath_faiTCqnlDOMSx7r33ARLuzmmXa8KLn95)">
        <g>
          <g>
            <g>
              <path
                d=" M 78.332 33.33 C 70.967 33.33 64.997 39.3 64.997 46.664 C 65.005 54.025 70.97 59.99 78.332 59.999 C 85.696 59.999 91.666 54.029 91.666 46.664 C 91.666 39.3 85.696 33.33 78.332 33.33 Z  M 78.332 56.665 C 72.808 56.665 68.331 52.188 68.331 46.664 C 68.336 41.143 72.81 36.669 78.332 36.663 C 83.855 36.663 88.332 41.141 88.332 46.664 C 88.332 52.188 83.855 56.665 78.332 56.665 Z "
                className={props.className}
              />
            </g>
          </g>
          ...
          <g>
            <g>
              <rect
                ...
                width="3.334"
                height="5"
                transform="matrix(0.707,-0.707,0.707,0.707,-4.44,55.501)"
                fill="rgb(255,255,255)"
              />
            </g>
          </g>
          <g>
            <g>
              <rect
                ...
                width="3.334"
                height="5"
                transform="matrix(0.707,-0.707,0.707,0.707,-15.667,82.608)"
                fill="rgb(255,255,255)"
              />
            </g>
          </g>
          <g>
            <g>
              <rect
                ...
                width="5"
                height="3.334"
                transform="matrix(0.707,-0.707,0.707,0.707,-23.605,63.44)"
                fill="rgb(255,255,255)"
              />
            </g>
          </g>
          <g>
            <g>
              <rect
                ...
                width="5"
                height="3.334"
                transform="matrix(0.707,-0.707,0.707,0.707,3.5,74.671)"
                fill="rgb(255,255,255)"
              />
            </g>
          </g>
