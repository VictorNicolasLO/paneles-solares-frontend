    ...
    <div
      dangerouslySetInnerHTML={{
        __html: `
			  ...
			  <svg fill="#1b396a" width="120"  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				   viewBox="0 0 301.605 301.605" style="enable-background:new 0 0 301.605 301.605;margin-bottom:20px" xml:space="preserve">
			  <g>
